    ...
    <Menu as="div" className="relative">
      {() => (
        <>
          ...
          >
            <Menu.Items className="absolute right-0 right-safe lg:right-0 z-50 mt-2 w-48 origin-top-right rounded-md bg-card dark:bg-card-dark shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none max-w-[calc(100vw-var(--safe-area-inset-left)-var(--safe-area-inset-right)-1rem)]">
              <div className="py-1">
                <UserMenuItem
                  icon={CircleUser}
                  label="Meu Perfil"
