    ...
    >
      <div
        className={cn(
          ...
          borderColor,
          isHighlight
            ? 'shadow-emerald-100 dark:shadow-emerald-900/20 ring-1 ring-emerald-500/50'
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full mt-2">
          ...
          <div className="text-center mb-8">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 capitalize tracking-tight">
              {plan.name}
            </h3>
            ...
            {plan.price === 0 && (
              <p className="mt-4 text-sm text-gray-500">Perfeito para começar</p>
            )}
            {plan.name === 'pro' && (
          ...
          <ul className="space-y-4 mb-8 flex-1">
            {plan.features.map((feature, i) => (
              <li key={i} className="flex items-start gap-3">
                <div
                  className={cn(
                    'rounded-full p-0.5 shrink-0 mt-0.5 bg-white dark:bg-gray-800',
                    themeText,
                  )}
                >
