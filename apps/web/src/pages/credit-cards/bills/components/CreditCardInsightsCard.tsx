...
import type { InsightItem, WarningItem, ProjectionItem } from '@/services/agentService';
...
function InsightItemRow({ insight }: { readonly insight: InsightItem }) {
  return (
    <div
...
function WarningItemRow({ warning }: { readonly warning: WarningItem }) {
  return (
    <div
...
function ProjectionRow({ projection }: { readonly projection: ProjectionItem }) {
  return (
...
interface InsightsContentProps {
  readonly insights: NonNullable<ReturnType<typeof useCreditCardInsights>['insights']>;
  readonly generateInsights: () => void;
  readonly isGenerating: boolean;
}

function InsightsContent({ insights, generateInsights, isGenerating }: InsightsContentProps) {
...
function resolveExpandedContent(
  ...
  isNoApiKey: boolean,
  error: unknown,
  insights: ReturnType<typeof useCreditCardInsights>['insights'],
