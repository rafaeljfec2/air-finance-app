    ...
    <section id="pricing" className="v3-section bg-[var(--v3-bg-alt)]">
      <div className="v3-container">
        <ScrollReveal className="text-center mb-6">
          ...
          <h2 className="v3-h2 mb-4">Escolha o ritmo do seu Check-up</h2>
              ...
              <HoverLift className="h-full">
                ...
                >
                  ...
                  <Link to="/pricing" className="w-full mt-auto">
                    <button
                      type="button"
                      className={`w-full py-3 rounded-xl font-semibold text-sm transition-all duration-200 flex items-center justify-center gap-2 group ${
                        plan.popular
