    ...
    <>
      ...
      <div className="landing-v2-page w-full bg-gray-50 text-gray-900 antialiased">
        ...
        <main className="relative w-full pt-20">
          <section className="v2-section bg-gradient-to-b from-gray-50 to-gray-100">
            <div className="v2-container">
              ...
              <div className="v2-text-center v2-mb-12">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#10b981]/10 mb-6">
                  <Link2 className="w-10 h-10 text-[#10b981]" />
                </div>
              ...
              {/* Introduction */}
              <div className="v2-card v2-mb-12 max-w-4xl mx-auto">
              ...
              <div className="space-y-8 max-w-4xl mx-auto">
                ...
                <div className="v2-card">
                  <div className="flex items-start gap-4 v2-mb-6">
                    <div className="flex-shrink-0 w-14 h-14 rounded-full bg-gradient-to-r from-[#10b981] to-[#059669] text-white flex items-center justify-center text-2xl font-bold shadow-lg">
                      1
                    </div>
                ...
                <div className="v2-card">
                  ...
                  <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                    <div className="flex items-start gap-3">
                      <Settings className="w-6 h-6 text-[#10b981] flex-shrink-0 mt-1" />
                      <div>
                        <p className="text-sm font-semibold text-blue-900 v2-mb-1">
                ...
                <div className="v2-card">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                      <h3 className="font-semibold text-gray-900 v2-mb-3 flex items-center gap-2">
                        <Eye className="w-5 h-5 text-[#10b981]" />
                        Opção A: Visualizar API Key Padrão
                      </h3>
                      <p className="text-sm text-gray-600 v2-mb-4">
                ...
                <div className="v2-card">
                  <div className="flex items-start gap-4 v2-mb-6">
                    ...
                    <div className="flex-1">
                      <h2 className="v2-h3 v2-mb-2">Configure no Air Finance</h2>
                      <p className="text-gray-600 v2-mb-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-green-50 rounded-lg p-6 border border-green-200">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-sm font-semibold text-green-900 v2-mb-1">
                ...
                {/* Security Note */}
                <div className="v2-card bg-yellow-50 border-2 border-yellow-200">
                  <h2 className="v2-h3 v2-mb-6 flex items-center gap-2 text-yellow-900">
                ...
                {/* Troubleshooting */}
                <div className="v2-card">
                  <h2 className="v2-h3 v2-mb-6">Problemas Comuns</h2>
                  <div className="space-y-4">
                    <div className="border-l-4 border-[#10b981] pl-4">
                      <h3 className="font-semibold text-gray-900 v2-mb-1">
                ...
                {/* CTA */}
                <div className="v2-card bg-gradient-to-r from-[#10b981] to-[#059669] text-white text-center">
                  <h2 className="v2-h3 v2-mb-4 text-white">Pronto para começar?</h2>
                  <p className="text-white/90 v2-mb-6">
                    Siga os passos acima e conecte suas contas bancárias em minutos
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      to="/register"
                      className="inline-flex items-center justify-center px-6 py-3 bg-white text-[#10b981] rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/20 text-white rounded-xl font-semibold hover:bg-white/30 transition-all duration-300 border-2 border-white/30 hover:border-white/50"
                    >
                      Acessar Pierre Finance
                      <ExternalLink className="w-5 h-5" />
                    </a>
