...
export function RecurringTransactionsErrorState({
  error,
}: Readonly<RecurringTransactionsErrorStateProps>) {
  ...
  return (
    <ViewDefault>
      <div className="container mx-auto px-4 sm:px-6 py-10">
        <div className="text-red-500">Erro ao carregar transações recorrentes: {error.message}</div>
      </div>
    </ViewDefault>
  );
}
