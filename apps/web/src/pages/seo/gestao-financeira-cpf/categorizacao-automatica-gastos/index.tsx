...
export function CategorizacaoAutomaticaGastosPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Porque exige tempo, atenção e repetição, tornando-se insustentável no longo prazo.',
    },
    {
          ...
          <main className="mx-auto max-w-4xl px-6 py-12 pb-24">
            <article className="prose prose-lg dark:prose-invert max-w-none prose-headings:text-text dark:prose-headings:text-text prose-headings:font-bold prose-headings:tracking-tight prose-h1:text-4xl prose-h1:mb-6 prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-text/80 dark:prose-p:text-text/80 prose-p:leading-relaxed prose-a:text-brand-arrow prose-a:no-underline hover:prose-a:underline prose-a:font-medium prose-strong:text-text dark:prose-strong:text-text prose-strong:font-semibold prose-li:text-text/80 dark:prose-li:text-text/80 prose-ul:text-text/80 dark:prose-ul:text-text/80 prose-ol:text-text/80 dark:prose-ol:text-text/80 prose-li:my-2">
              ...
              <section className="mb-12">
                <div className="prose-lg text-text/90 leading-relaxed bg-brand-arrow/5 rounded-xl p-6 border-l-4 border-brand-arrow">
                  <p className="m-0 text-lg font-medium">
                    Categorização automática de gastos é uma das funcionalidades mais práticas da
                    gestão financeira moderna. Ao invés de classificar manualmente cada transação, a
                    inteligência artificial aprende seus padrões e categoriza automaticamente. Este
                    guia explica como funciona, por que manual não escala e quais são os benefícios
                    reais.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p>
                  Categorização é o processo de classificar cada transação financeira em uma
                  categoria (alimentação, transporte, saúde, lazer, etc.). Isso permite:
                </p>
                <ul>
              ...
              <section>
                ...
                <p>
                  Categorização manual funciona quando você tem poucas transações. Mas quando você
                  tem dezenas ou centenas de transações por mês, manual se torna inviável:
                </p>

                <h3>1. Tempo Consumido</h3>
                <p>
                  Classificar manualmente 100 transações por mês leva tempo. Mesmo que sejam 2
                  minutos por transação, são 200 minutos (mais de 3 horas) por mês só categorizando.
                  Esse tempo poderia ser usado para análise, não para trabalho repetitivo.
                </p>
              ...
              <section>
                ...
                <p>
                  ...
                  padrão e passa a classificar automaticamente. Quanto mais transações
                  categorizadas, melhor a IA fica.
                </p>
              ...
              <section>
                ...
                <p>
                  ...
                  medicamento (Saúde) ou produto de higiene (Casa). IA pode errar nesses casos, e
                  você precisa corrigir manualmente.
                </p>
                ...
                <p>
                  Transações com descrições muito genéricas (apenas números de conta, por exemplo)
                  são difíceis de categorizar. IA pode sugerir, mas você precisa classificar
                  manualmente.
                </p>
                ...
                <p>
                  Apesar das limitações, IA acerta na maioria dos casos (85-95% de precisão é
                  comum). Os 5-15% restantes você corrige manualmente, e mesmo assim economiza muito
                  tempo.
                </p>
              </section>
              ...
              <section>
                ...
                <ol>
                  ...
                  <li>
                    <strong>Correção inicial:</strong> Você corrige categorizações erradas. IA
