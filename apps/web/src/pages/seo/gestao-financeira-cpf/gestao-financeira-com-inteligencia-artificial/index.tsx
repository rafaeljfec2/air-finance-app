...
export function GestaoFinanceiraComIAPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Não. A IA fornece dados e sugestões; a decisão final continua sendo do usuário.',
    },
    {
      question: 'IA substitui planejamento financeiro humano?',
      answer: 'Não. Ela complementa, mas não substitui análise consciente e objetivos pessoais.',
    },
  ];
          ...
          <header className="border-b border-gray-800 bg-[#0b1120]/95 backdrop-blur-sm sticky top-0 z-30">
            <div className="mx-auto max-w-4xl px-6 py-4">
              <nav className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <ChevronRight className="w-4 h-4 text-gray-500 text-white" />
                <span className="text-gray-100 font-medium">Gestão Financeira com IA</span>
              </nav>
            </div>
          </header>
            ...
            <article className="prose prose-lg prose-invert max-w-none prose-headings:text-gray-50 prose-headings:font-bold prose-headings:tracking-tight prose-h1:text-4xl prose-h1:mb-6 prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-gray-300 prose-p:leading-relaxed prose-a:text-emerald-400 prose-a:no-underline hover:prose-a:underline prose-a:font-medium prose-strong:text-gray-100 prose-strong:font-semibold prose-li:text-gray-300 prose-ul:text-gray-300 prose-ol:text-gray-300 prose-li:my-2">
              ...
              <section className="mb-12">
                <div className="prose-lg text-text/90 leading-relaxed bg-brand-arrow/5 rounded-xl p-6 border-l-4 border-brand-arrow">
                  <p className="m-0 text-lg font-medium">
                    Inteligência artificial em gestão financeira não é ficção científica, é
                    realidade prática que já funciona hoje. Mas não é milagre: é ferramenta que
                    ajuda em tarefas específicas, não substitui julgamento humano. Este guia explica
                    o que IA faz de verdade, onde ela ajuda e onde não ajuda.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  lazer). Aprende com seus padrões e melhora com o tempo. Economiza horas de
                  trabalho manual por mês.
                </p>
                ...
                <p>
                  ...
                  acima do padrão ou recomendar otimizações baseadas em histórico. São sugestões,
                  não comandos: você decide.
                </p>
              </section>

              <section>
                <h2>Onde IA Ajuda</h2>
                <p>IA é útil em tarefas específicas onde ela é melhor que humanos:</p>
              ...
              <section>
                ...
                <p>
                  ...
                  em lazer por mês pode ser excesso, para outra pode ser necessário para qualidade
                  de vida. IA não sabe disso, você sabe.
                </p>
              ...
              <section>
                ...
                <p>IA em gestão financeira não é milagre. Não vai:</p>
                <ul>
