...
export function OrganizacaoFinanceiraPessoalPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Com dados claros e automação, os primeiros resultados aparecem em poucos meses.',
    },
  ];
          ...
          <header className="border-b border-gray-800 bg-[#0b1120]/95 backdrop-blur-sm sticky top-0 z-30">
            <div className="mx-auto max-w-4xl px-6 py-4">
              <nav className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <ChevronRight className="w-4 h-4 text-gray-500 text-white" />
                <span className="text-gray-100 font-medium">Organização Financeira Pessoal</span>
              </nav>
            </div>
          </header>
          <main className="mx-auto max-w-4xl px-6 py-12 pb-24">
            <article className="prose prose-lg prose-invert max-w-none prose-headings:text-gray-50 prose-headings:font-bold prose-headings:tracking-tight prose-h1:text-4xl prose-h1:mb-6 prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-gray-300 prose-p:leading-relaxed prose-a:text-emerald-400 prose-a:no-underline hover:prose-a:underline prose-a:font-medium prose-strong:text-gray-100 prose-strong:font-semibold prose-li:text-gray-300 prose-ul:text-gray-300 prose-ol:text-gray-300 prose-li:my-2">
              ...
              <section className="mb-12">
                <div className="prose-lg text-text/90 leading-relaxed bg-brand-arrow/5 rounded-xl p-6 border-l-4 border-brand-arrow">
                  <p className="m-0 text-lg font-medium">
                    Organização financeira pessoal vai além de apenas controlar gastos. É sobre
                    criar estrutura, separar o essencial do opcional, visualizar claramente onde
                    está seu dinheiro e manter disciplina baseada em dados, não em força de vontade.
                  </p>
                </div>
              </section>
              <section>
                ...
                <p>
                  Durante o mês, acompanhe seus gastos. Não precisa revisar diariamente, mas
                  verifique semanalmente se está dentro do orçamento. Use{' '}
                ...
                <p>
                  No final do mês, analise o que aconteceu. Identifique desvios do orçamento.
                  Prepare o planejamento do próximo mês com os dados do mês atual.
                </p>
                <p>
              ...
              <section>
                ...
                <p>Separar gastos fixos de variáveis é fundamental para organização financeira:</p>
                <h3>Gastos Fixos</h3>
                <p>
              ...
              <section>
                ...
                <p>
                  Organização financeira eficiente requer visualização clara. Números em planilha
                  são
                </p>
                <h3>Gráfico de Pizza (Por Categoria)</h3>
                <p>
                  Mostra visualmente qual porcentagem do orçamento vai para cada categoria:
                  alimentação, transporte, moradia, lazer. Você vê imediatamente se uma categoria
                  está consumindo muito do orçamento.
                </p>
              ...
              <section>
                ...
                <p>
                  Disciplina financeira não vem de força de vontade, vem de hábitos baseados em
                  dados:
                </p>
                <h3>Dados Reais vs. Estimativas</h3>
                <p>
                  Quando você tem dados reais sobre seus gastos, decisões ficam mais fáceis. Ao
                  invés de &quot;acho que gasto muito em restaurantes&quot;, você sabe: &quot;gasto
                  R$ 800 por mês em restaurantes, que é 20% do meu orçamento&quot;. Com dados, você
                  decide racionalmente, não emocionalmente.
                </p>
