          ...
          <header className="border-b border-gray-800 bg-[#0b1120]/95 backdrop-blur-sm sticky top-0 z-30">
            <div className="mx-auto max-w-4xl px-6 py-4">
              <nav className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <ChevronRight className="w-4 h-4 text-gray-500 text-white" />
                <span className="text-gray-100 font-medium">Score de Crédito</span>
              </nav>
            </div>
          </header>
          ...
          <main className="mx-auto max-w-4xl px-6 py-12 pb-24">
            <article className="prose prose-lg prose-invert max-w-none prose-headings:text-gray-50 prose-headings:font-bold prose-headings:tracking-tight prose-h1:text-4xl prose-h1:mb-6 prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-gray-300 prose-p:leading-relaxed prose-a:text-emerald-400 prose-a:no-underline hover:prose-a:underline prose-a:font-medium prose-strong:text-gray-100 prose-strong:font-semibold prose-li:text-gray-300 prose-ul:text-gray-300 prose-ol:text-gray-300 prose-li:my-2">
              ...
              <section>
                ...
                <p>Score é calculado por bureaus de crédito (Serasa, Boa Vista, SPC) baseado em:</p>
                <ul>
              ...
              <section>
                ...
                <p>Entender quais comportamentos afetam score ajuda a melhorá-lo:</p>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Uso moderado de crédito:</strong> Usar crédito regularmente, mas de
                    forma moderada (menos de 30% do limite)
                  </li>
                  <li>
                    <strong>Histórico longo:</strong> Ter histórico de crédito longo e positivo
                  </li>
                  <li>
                    <strong>Diversidade de crédito:</strong> Ter diferentes tipos de crédito
                    (cartão, financiamento, empréstimo) paga de forma responsável
                  </li>
                  <li>
              ...
              <section>
                ...
                <p>
                  Organização financeira permite planejar pagamentos grandes. Você evita usar
                  crédito de forma desesperada, o que reduz consultas excessivas ao CPF.
                </p>

                <h3>4. Identificação de Padrões</h3>
                <p>
                  Controle financeiro ajuda a identificar padrões de gasto. Você vê quando gasta
                  mais e pode planejar, evitando necessidade de crédito de emergência.
                </p>
              ...
              <section>
                ...
                <p>Algumas coisas que as pessoas pensam que melhoram score, mas não funcionam:</p>
                <ul>
                  <li>
