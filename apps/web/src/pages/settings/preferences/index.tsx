              ...
              <div className="space-y-6">
                ...
                <div>
                  <label
                    ...
                    className="block text-sm font-medium text-text dark:text-text-dark mb-2 flex items-center gap-2"
                  >
                ...
                <div>
                  ...
                  <Select value={preferences.theme} onValueChange={(v) => handleChange('theme', v)}>
                    <SelectTrigger className="bg-background dark:bg-background-dark border-border dark:border-border-dark text-text dark:text-text-dark">
