        ...
        <Card className="p-2 bg-card dark:bg-card-dark border-border dark:border-border-dark backdrop-blur-sm">
          <div className="flex items-center justify-between space-x-3">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Receitas</p>
        ...
        <Card className="p-2 bg-card dark:bg-card-dark border-border dark:border-border-dark backdrop-blur-sm">
          <div className="flex items-center justify-between space-x-3">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Despesas</p>
