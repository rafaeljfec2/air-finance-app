...
export function UserPermissionsModal({ open, onClose, role, userName }: UserPermissionsModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={`Permissões: ${userName}`} className="max-w-3xl">
