  ...
  return (
    <ViewDefault>
      <div className="container mx-auto px-2 sm:px-6 pt-0 pb-10">
        <div className="min-h-screen bg-gradient-to-br from-background to-white dark:from-background-dark dark:to-gray-900 px-4 pt-0 pb-12 flex flex-col items-center">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <span
                      className={cn(
                        ...
                        categoryColors[tx.userCategory || tx.iaCategory] ||
