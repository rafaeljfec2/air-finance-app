...
export function GoalsEmptyState({ hasFilters, onCreate }: Readonly<GoalsEmptyStateProps>) {
  const emptyTitle = hasFilters ? 'Nenhuma meta encontrada' : 'Nenhuma meta cadastrada';
