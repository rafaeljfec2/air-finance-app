      ...
      <div className="min-h-screen bg-background text-text">
        ...
        <main className="mx-auto max-w-4xl px-6 py-12 pb-24">
          <article className="prose prose-lg dark:prose-invert max-w-none prose-headings:text-text dark:prose-headings:text-text prose-headings:font-bold prose-p:text-text/80 dark:prose-p:text-text/80 prose-a:text-brand-arrow prose-a:no-underline hover:prose-a:underline prose-strong:text-text dark:prose-strong:text-text prose-li:text-text/80 dark:prose-li:text-text/80 prose-ul:text-text/80 dark:prose-ul:text-text/80 prose-ol:text-text/80 dark:prose-ol:text-text/80 ">
            ...
            <section>
              <p className="lead">
                Controle financeiro pessoal é a base de tudo. Sem saber quanto você gasta, qualquer
                planejamento é baseado em suposições. Este guia explica métodos práticos para
                controlar gastos pessoais, identificar erros comuns e escolher entre controle manual
                e automatizado.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Controle de gastos pessoais funciona em três etapas simples:
              </p>
              <ol>
                <li>
            ...
            <section>
              ...
              <p>
                Planilhas mostram números, mas não mostram padrões facilmente. Identificar que você
                gasta mais em fins de semana ou em determinados meses requer análise manual
                trabalhosa.
              </p>
            </section>
