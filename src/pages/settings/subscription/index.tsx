...
export function SubscriptionManagementPage() {
  ...
  const currentPlanId = subscription?.plan || (user as { plan?: string })?.plan || 'free';
  ...
  return (
    <ViewDefault>
      <ViewHeader title="Minha Assinatura" description="Gerencie seu plano e método de pagamento" />
